                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($faqsData as $faqs)
                                            <tr class="single-item">
                                                ...
                                                <td>{{ $faqs->faq_type == 'pricing_page' ? 'Pricing Page' : 'Contact Page' }}
                                                </td>
                                                <td>{{ $faqs->question }}</td>
                                                <td>{{ $faqs->position_order }}</td>
                                                <td>
                                                    <input class="form-check-input c-pointer"
                                                        onclick="change_status('<?= $model ?>', <?= $sno ?>, '<?= $faqs->encrypted_id ?>');"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.edit.faq', $faqs->encrypted_id) }}">
                                                                ...
                                                                <li>
                                                                    <button class="dropdown-item"
                                                                        onclick="delete_item('<?= $model ?>', '<?= $faqs->encrypted_id ?>');">
