...
@section('page-content')
    <div class="nxl-content">
        <!-- [ page-header ] start -->
        <form
            action="{{ !empty($service->encrypted_id) ? route('admin.edit.service', $service->encrypted_id) : route('admin.add.service') }}"
            ...
            <div class="page-header sticky-top">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.manage_services') }}">All Services</a>
                        </li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4">
                                    <label for="service_title" class="form-label">Service Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="service_title" name="service_title"
                                        value="{{ !empty($service->encrypted_id) ? $service->service_title : old('service_title') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="service_name" name="service_name"
                                        value="{{ !empty($service->encrypted_id) ? $service->service_name : old('service_name') }}"
                                ...
                                <div class="mb-4">
                                    <label for="service_url" class="form-label">Service URL <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="service_url" name="service_url"
                                        value="{{ !empty($service->encrypted_id) ? $service->service_url : old('service_url') }}"
                                ...
                                <div class="mb-4">
                                    <label for="service_icon" class="form-label">Service Icon <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="service_icon" name="service_icon"
                                        value="{{ !empty($service->encrypted_id) ? $service->service_icon : old('service_icon') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="short_description" id="short_description" cols="30" rows="10" class="form-control"
                                        placeholder="Enter Short Description">{{ !empty($service->encrypted_id) ? htmlspecialchars_decode($service->short_description) : old('short_description') }}</textarea>
                                    @error('short_description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                {{-- <div class="mb-4">
                                    <label for="button_name" class="form-label">Botton Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="button_name" name="button_name"
                                        value="{{ !empty($service->encrypted_id) ? $service->button_name : old('button_name') }}"
                                        placeholder="Enter <i></i> Tag Icon" />
                                    @error('button_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    <label for="service_highlights" class="form-label">Service Highlights <span
                                            class="text-danger">*</span></label>
                                    <textarea name="service_highlights" id="service_highlights" cols="30" rows="10" class="form-control"
                                        placeholder="Enter Highlights">{{ !empty($service->encrypted_id) ? htmlspecialchars_decode($service->service_highlights) : old('service_highlights') }}</textarea>
                                    @error('service_highlights')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control"
                                        placeholder="Enter Description">{{ !empty($service->encrypted_id) ? htmlspecialchars_decode($service->description) : old('description') }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="breadcrumb_headline"
                                        ...
                                        value="{{ !empty($service->encrypted_id) ? $service->breadcrumb_headline : old('breadcrumb_headline') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="breadcrumb_description" id="breadcrumb_description" cols="30" rows="10"
                                        class="form-control" placeholder="Enter Breadcrumb Description">{{ !empty($service->encrypted_id) ? htmlspecialchars_decode($service->breadcrumb_description) : old('breadcrumb_description') }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title"
                                        value="{{ !empty($service->encrypted_id) ? $service->meta_title : old('meta_title') }}"
                                        placeholder="Enter Title" />
                                    @error('meta_title')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="meta_keyword" name="meta_keyword"
                                        value="{{ !empty($service->encrypted_id) ? $service->meta_keyword : old('meta_keyword') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="form-control"
                                        placeholder="Enter Meta Description">{{ !empty($service->encrypted_id) ? htmlspecialchars_decode($service->meta_description) : old('meta_description') }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4">
                                    <label for="service_image" class="form-label">Service Image <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-4">
                                    <label for="breadcrumb_image" class="form-label">Breadcrumb Image <span
                                            class="text-danger">*</span></label>
                                    @if (!empty($service->encrypted_id) && !empty($service->breadcrumb_image))
                                        <div class="my-3">
                                            <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                                <a href="javascript:void(0)" class="avatar-image avatar-md"
                                                    data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                    title="breadcrumb_image">
                                                    <img src="{{ asset($service->breadcrumb_image) }}" class="img-fluid"
                                                        alt="image" />
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <h5 class="card-header mb-3">Section Contents</h5>
                    <div id="all-contents"></div>
                    <span class="float-end">
                        <button type="button" class="btn btn-primary float-end" id="add-content">
                            <i class="feather-save me-2"></i>
                            <span>Add</span>
                        </button>
                    </span>
    ...
    <script>
        function getUrl(field_id) {
            ...
            if (errors > 0) {
                ...
                let url = "{{ route('admin.check.service.link', ['service_url' => '__LINK__', 'id' => '__ID__']) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addRow(item = {}) {
                ...
                idInput.type = 'hidden';
                idInput.name = 'contents[]';
                idInput.value = item.content_id || '';
                cardBody.appendChild(idInput);

                // ------------------------------------- Create the row (Content Title & Content Headline) ------------------------------------------
                ...
                label1.htmlFor = `contentIcons-${rowCount}`;
                label1.className = 'col-form-label';
                label1.textContent = 'Content Icon';

                // ----------- Input field ------------
                const input1 = document.createElement('input');
                input1.type = 'text';
                input1.className = 'form-control';
                input1.id = `contentIcons-${rowCount}`;
                input1.name = 'content_icons[]';
                input1.placeholder = 'Enter <i></i> Tag Icon';
                input1.value = item.content_icon || '';
                ...
                label11.htmlFor = `contentHeadlines-${rowCount}`;
                label11.className = 'col-form-label';
                label11.textContent = 'Content Headline';

                // ----------- Input field ------------
                const input11 = document.createElement('input');
                input11.type = 'text';
                input11.className = 'form-control';
                input11.id = `contentHeadlines-${rowCount}`;
                input11.name = 'content_headlines[]';
                input11.placeholder = 'Enter Headline';
                input11.value = item.content_headline || '';
                ...
                // -------------- Append input to column and label + column to row (Content Title & Content Headline) -----------------------
                ...
                // fileInputLabel.textContent = 'Content Image';
                // fileInputLabel.htmlFor = `contentImages-${rowCount}`;
                // fileInputCol.appendChild(fileInputLabel);

                // // ----------- File Input field ------------
                // const fileInput = document.createElement('input');
                // fileInput.type = 'file';
                // fileInput.id = `contentImages-${rowCount}`;
                // fileInput.name = 'content_images[]';
                ...
                //     const file = item.content_images; // Assuming 'item.content_images' contains existing file names
            ...
            //             `;
                ...
                removeButton.onclick = function() {
                    if (item.content_id != "" && item.content_id != undefined && item.content_id != null) {
                        $.ajax({
                            url: "{{ route('admin.delete.service.content') }}",
                            method: "POST",
                            data: {
                                "_token": '{{ csrf_token() }}',
                ...
                document.getElementById('all-contents').appendChild(card);
            ...
            @if (!empty($service->encrypted_id))
                ...
                // Fetch data from the server (get_sub_content_data.php) and add rows
                fetch("{{ route('admin.get.service.contents', $service->encrypted_id) }}")
