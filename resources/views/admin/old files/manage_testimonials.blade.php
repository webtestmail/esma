        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Manage Testimonials</li>
                </ul>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($testimonialsData as $testimonial)
                                            <tr class="single-item">
                                                ...
                                                <td>{{ $testimonial->rating_quantity }}</td>
                                                <td>{{ $testimonial->position_order }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <input class="form-check-input c-pointer"
                                                        onclick="change_status('<?= $model ?>', <?= $sno ?>, '<?= $testimonial->encrypted_id ?>');"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.edit.testimonial', $testimonial->encrypted_id) }}">
                                                                ...
                                                                <li>
                                                                    <button class="dropdown-item"
                                                                        onclick="delete_item('<?= $model ?>', '<?= $testimonial->encrypted_id ?>');">
