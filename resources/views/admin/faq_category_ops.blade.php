...
@section('page-content')
    <div class="nxl-content">
        <!-- [ page-header ] start -->
        <form
            action="{{ !empty($category->encrypted_id) ? route('admin.edit.faqcategory', $category->encrypted_id) : route('admin.add.faqcategory') }}"
            ...
            <div class="page-header sticky-top">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.manage_faqcategory') }}">All Category</a></li>
                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        <div class="d-flex d-md-none">
                            <a href="{{ route('admin.manage_faqcategory') }}" class="page-header-right-close-toggle">
